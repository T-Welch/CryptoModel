...
JFLAGS = -g
JVM = java
JCP = -cp .libraries/*.jar --module-path /Users/trevor/Documents/javafx-sdk-17.0.2/lib --add-modules javafx.controls,javafx.fxml
...
CryptoMain.class: CryptoMain.java
	$(JCC) $(JFLAGS) $(JCP) CryptoMain.java

clean:
	$(RM) *.class

run:
	$(JVM) $(JCP) $(ARGS) CryptoMain
